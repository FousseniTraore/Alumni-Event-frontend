...
const Contact = () => {
  return (
    <div>
      ...
      <section class="relative overflow-hidden font-poppins mt-20 bg-blue-950">
          ...
          <div class="max-w-5xl mx-auto">
            <div class="flex flex-col-reverse py-20 -mx-4 lg:flex-row 2xl:py-40">
              <div class="w-full px-4 lg:w-3/5">
                <div class="w-full px-8 py-8 bg-white border rounded-md shadow-md lg:ml-20 lg:max-w-md">
                  <form action="">
                    <div class="mb-6">
                    ...
                    ></textarea>
                    <button class="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-blue-950 rounded-md hover:bg-blue-800">
                      Send Message
                    </button>
                  </form>
                </div>
              ...
              <div class="w-full px-4 mb-8 lg:w-2/5 lg:mb-0">
                ...
                <h2 class="mt-6 mb-8 text-4xl font-bold md:mb-10 text-white">
                  Lets get connected
                </h2>
                <div class="flex items-center mb-6">
                  <span class="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
                      class="w-5 h-5 text-blue-600 bi bi-telephone"
                      viewBox="0 0 16 16"
                    >
                ...
                <div class="flex items-center mb-6">
                  <span class="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      class="w-5 h-5 text-blue-600 bi bi-envelope"
                      viewBox="0 0 16 16"
                    >
                ...
                <div class="flex items-center mb-6">
                  <span className="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-4 bg-blue-100 rounded-lg">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      class="w-5 h-5 text-blue-600 bi bi-geo-alt"
                      viewBox="0 0 16 16"
                    >
